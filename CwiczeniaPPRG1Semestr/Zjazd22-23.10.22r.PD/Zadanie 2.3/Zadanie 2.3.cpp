/*POLECENIE: Użyj instrukcji switch i napisz program, który:
...
e)Wypisze czy w tym miesiącu jest słonecznie, czy pochmurno. Słonecznie jest od kwietnia włącznie do września włącznie. (2PKT)*/
